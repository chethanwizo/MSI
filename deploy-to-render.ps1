...
Write-Host "1. 🗄️ Create PostgreSQL Database on Render:" -ForegroundColor Magenta
...
Write-Host "   • Name: mis-analytics-db" -ForegroundColor White
Write-Host "   • Database: mis_analytics" -ForegroundColor White
Write-Host "   • User: mis_user" -ForegroundColor White
Write-Host "   • Plan: Free" -ForegroundColor White
Write-Host "   • COPY THE DATABASE URL!" -ForegroundColor Red
Write-Host ""

Write-Host "2. 🌐 Create Web Service on Render:" -ForegroundColor Magenta
...
Write-Host "3. 🔧 Set Environment Variables in Render:" -ForegroundColor Magenta
Write-Host "   NODE_ENV=production" -ForegroundColor White
Write-Host "   PORT=10000" -ForegroundColor White
Write-Host "   DATABASE_URL=<your-render-postgres-url>" -ForegroundColor Yellow
...
Write-Host "4. 🚀 Deploy Backend:" -ForegroundColor Magenta
...
Write-Host "5. 🌐 Deploy Frontend to Vercel:" -ForegroundColor Magenta
...
Write-Host "6. 🔗 Update CORS:" -ForegroundColor Magenta
